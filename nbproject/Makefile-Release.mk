...
${OBJECTDIR}/src/cod4/callables.o: src/cod4/callables.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cod4/callables.o src/cod4/callables.cpp

${OBJECTDIR}/src/cod4/controller.o: src/cod4/controller.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cod4
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cod4/controller.o src/cod4/controller.cpp

${OBJECTDIR}/src/cod4/events.o: src/cod4/events.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cod4
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cod4/events.o src/cod4/events.cpp
...
${OBJECTDIR}/src/globals.o: src/globals.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/globals.o src/globals.cpp

${OBJECTDIR}/src/ipc/ipc_comm.o: src/ipc/ipc_comm.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/ipc
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ipc/ipc_comm.o src/ipc/ipc_comm.cpp

${OBJECTDIR}/src/ipc/ipc_event.o: src/ipc/ipc_event.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/ipc
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ipc/ipc_event.o src/ipc/ipc_event.cpp

${OBJECTDIR}/src/ipc/ipc_rx_func_pkt.o: src/ipc/ipc_rx_func_pkt.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/ipc
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ipc/ipc_rx_func_pkt.o src/ipc/ipc_rx_func_pkt.cpp

${OBJECTDIR}/src/ipc/ipc_server_man.o: src/ipc/ipc_server_man.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/ipc
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ipc/ipc_server_man.o src/ipc/ipc_server_man.cpp
