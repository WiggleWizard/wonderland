...
${OBJECTDIR}/src/cod4/player.o: src/cod4/player.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/cod4
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/cod4/player.o src/cod4/player.cpp

${OBJECTDIR}/src/globals.o: src/globals.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/globals.o src/globals.cpp
